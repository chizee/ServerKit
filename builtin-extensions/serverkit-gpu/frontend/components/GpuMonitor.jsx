// GPU Monitor page — the serverkit-gpu extension's UI, moved out of core as the
// first CORE_SLIM slice (plan 32 #7). Imports come from the SDK (PageTopbar,
// KpiBand, api, useToast); EmptyState + Button are host components not yet on the
// SDK surface, so they resolve via the `@/` alias (fine for the baked path — a
// future runtime-ESM build would bundle them or promote them into the SDK).
