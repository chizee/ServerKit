...
### #33 — Agency scale (workspaces, RBAC, white-label, reports) `[XL]` 🟡 — ⏸️ Deferred (XL epic — split into its own milestone; touches cross-cutting models + RBAC + reports)
