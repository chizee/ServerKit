...
### #33 — Agency scale (workspaces, RBAC, white-label, reports) `[XL]` 🟡 — 🟡 In progress (reports slice ✅ shipped; `workspace_id` FKs + per-site ACL + server-side branding still deferred as a milestone)
